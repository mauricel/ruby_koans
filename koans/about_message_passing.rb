...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # __send__ is not generally overidden
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # > It would not throw NoMethodError. 
    # > Would it mean that typical.foobar() return god knows what?
    #
    # NOTE:
    #
  ...
  def test_catching_messages_makes_respond_to_lie
    ...
    assert_nothing_raised do
      catcher.any_method # the lie - we should have thrown
    end
    assert_equal false, catcher.respond_to?(:any_method) # the truth
  end
