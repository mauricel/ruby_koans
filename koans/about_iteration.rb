...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject is equivalent to the javascript reduce method
    # the parameter for the inject method is the initial value
    # the block has two parameters: accumulator and item. The block returns the new accumulator value
  end
