...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # > Greedy: Matches as much as possible, when * or + operators are used with a 'terminating' pattern (ie. it consumes instances of terminating pattern until the last one)
  # > Lazy: Matches as few times as possible, stopping at the terminating pattern
  ...
  # > A character class specifies the possible characters that a character may be
  # > And alternation specifies between possible character sequences.
  ...
  def test_sub_is_like_find_and_replace
    # .sub()  performs a single substitution
    #  first it matches the  regular expression
    #   the first match is passed into  the block
    #   the block replaces the string value of the match with the return value of the block
    #  in this case  array notation is used  to pick the character starting at index zero, length one
